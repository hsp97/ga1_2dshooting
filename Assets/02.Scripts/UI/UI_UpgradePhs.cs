...
public class UI_UpgradePhs : MonoBehaviour
{
    ...
    private readonly IUpgrade _upgradePhs;

    public UI_UpgradePhs(IUpgrade upgradePhs)
    {
        _upgradePhs = upgradePhs;
    }
    ...
    public void OnClick()
    {
        ...
        _upgradePhs.LevelUp(_index);
    }

    // 새로고침
    public void Refresh()
    {
        // Upgrade upgrade = UpgradeManagerPhs.Instance.Upgrades[_index];
        //
